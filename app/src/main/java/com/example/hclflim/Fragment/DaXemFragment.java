...
public class DaXemFragment extends Fragment {
    RecyclerView recyclerView;
    TaiKhoan taiKhoan;
    ArrayList<Phim> listPhims = new ArrayList<>();
    DaXemAdapter daXemAdapter;
    public DaXemFragment(TaiKhoan taiKhoan) {
    ...
    private void loaddulieu() {
        Query Phimdata = FirebaseDatabase.getInstance().getReference().child("TaiKhoan").child(taiKhoan.getSDT()).child("DaXem");
